        ...
        >
          <div>
            ...
            <motion.h1
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8 }}
              className="text-[3.2rem] font-black leading-[0.95] tracking-[-0.05em] md:text-[5rem]"
            >
              NGUYỄN
              <br />
              TRƯƠNG
  ...
  const lightAbout = [
    {
      emoji: "🇻🇳",
      title: "vietnam",
      text: "from ho chi minh city — or saigon, the warmer and more familiar name. a city of movement, noise, late-night coffee, endless motorbikes, football culture, and hidden stories inside tiny alleyways.",
    },
    {
      emoji: "💻",
      title: "coding",
      text: "started programming in 7th grade out of curiosity. somehow turned into late-night debugging sessions, startup internships, and an obsession with building meaningful things.",
    },
    {
      emoji: "⚽",
      title: "sports",
        ...
        <div className="grid gap-8 lg:grid-cols-[1fr_1.4fr]">
          ...
          <div className="space-y-6">
            {hobbies.map((hobby, index) => (
              <div
                key={hobby.title}
                className="group border-b pb-6 transition-all duration-500"
                style={{
                  borderColor: theme.border,
                }}
              >
                <div className="flex items-start justify-between gap-6">
                  <div>
                    ...
                    <p
                      style={{ color: theme.accent }}
                      className="mt-3 ml-10 text-sm uppercase tracking-[0.25em]"
                    >
                      {hobby.subtitle}
                    </p>
                  </div>
                ...
                <p
                  style={{ color: theme.muted }}
                  className="mt-2 ml-10 max-w-xl text-lg leading-relaxed"
                >
                  {hobby.description}
                </p>
              </div>
...
function Education({ theme }: any) {
  ...
  return (
    <section
      id="education"
      className="relative overflow-hidden px-8 py-8 lg:px-20"
    >
      {/* background glow */}
      <div
        style={{
        ...
        className="absolute left-0 top-0 h-[400px] w-[400px] rounded-full blur-3xl"
      />
        ...
        <div className="grid gap-20 lg:grid-cols-[0.8fr_1.4fr]">
          ...
          <div className="space-y-16">
            {schools.map((school, index) => (
              <div
                key={school.name}
                className="group border-b pb-12 transition-all duration-500"
                style={{
                  borderColor: theme.border,
                }}
              >
                ...
                <p
                  style={{ color: theme.muted }}
                  className="mt-8 ml-10 text-lg leading-relaxed"
                >
                  {school.detail}
                </p>
              </div>
        ...
        <div className="space-y-8">
          {blogs?.map((post: any, index: number) => (
            <motion.a
              ...
              className={`group grid items-center gap-16 lg:grid-cols-2 ${index % 2 === 1
            ...
            >
              ...
              >
                {post.image ? (
                  <>
                    <div className="absolute inset-0 z-10 bg-black/20 transition duration-700 group-hover:bg-black/0" />
                  ...
                  <div
                    className="flex h-[550px] w-full items-center justify-center text-2xl font-medium"
                    style={{
                      background: darkMode
                        ? "#111"
                        : "#f5f1e8",
                ...
                {/* FLOATING DATE */}
                <div
                  className="absolute bottom-6 left-6 z-20 rounded-full border border-white/10 bg-black/40 px-5 py-2 text-sm backdrop-blur-xl"
                  style={{
                    color: "#fff",
                  }}
                >
              ...
              >
                ...
                <h3 className="text-4xl font-semibold leading-[1.02] tracking-[-0.06em] md:text-7xl">
                  {post.title}
                </h3>
